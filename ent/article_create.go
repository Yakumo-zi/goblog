...
func (ac *ArticleCreate) SetCategoryID(id int) *ArticleCreate {
	ac.mutation.SetCategoryID(id)
	return ac
}

// SetNillableCategoryID sets the "category" edge to the Category entity by ID if the given value is not nil.
func (ac *ArticleCreate) SetNillableCategoryID(id *int) *ArticleCreate {
	if id != nil {
...
func (ac *ArticleCreate) createSpec() (*Article, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.CategoryIDs(); len(nodes) > 0 {
		...
		_node.category_articles = &nodes[0]
