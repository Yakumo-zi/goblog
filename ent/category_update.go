...
func (cu *CategoryUpdate) AddArticleIDs(ids ...int) *CategoryUpdate {
...
func (cu *CategoryUpdate) RemoveArticleIDs(ids ...int) *CategoryUpdate {
...
// AddArticleIDs adds the "articles" edge to the Article entity by IDs.
func (cuo *CategoryUpdateOne) AddArticleIDs(ids ...int) *CategoryUpdateOne {
...
// RemoveArticleIDs removes the "articles" edge to Article entities by IDs.
func (cuo *CategoryUpdateOne) RemoveArticleIDs(ids ...int) *CategoryUpdateOne {
